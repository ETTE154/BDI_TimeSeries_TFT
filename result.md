...
![output15](https://user-images.githubusercontent.com/109407983/233990245-4f24d4d9-2eec-42fc-9d91-523ff97daa29.png)
...
### Q : best_tft.plot_interpretation(interpretation) 의 결과중 하나인 Attention 에서 최근 10스텝(10주)간의 데이터에 대한 Attention이 높게 나왔다.  이때에 BDI를 예측하는 프로젝트의 발표자가 되었다 가정하고 결과를 해석하여라.

![output13](https://user-images.githubusercontent.com/109407983/233990515-6eadd979-af05-4757-9637-eeed331ad803.png)

  - A : Attention 결과에서 최근 10주간의 데이터에 대한 Attention이 높게 나왔다는 것은, 모델이 BDI를 예측하는 데 있어 최근 10주간의 데이터를 중요하게 고려한다는 것을 의미합니다. 이러한 결과는 여러 가지 인사이트를 제공합니다.
  ...
  - 또한, 이러한 결과는 BDI 예측 모델의 성능을 개선하기 위해 최근의 데이터를 더욱 집중적으로 분석하고 이해하는 것이 중요하다는 것을 시사합니다. 예를 들어, 최근 10주간의 데이터를 더 자세히 살펴보면, 특정 경제 이벤트나 금융 정책 변화가 BDI에 어떤 영향을 미쳤는지 파악할 수 있으며, 이를 바탕으로 더 정확한 예측을 수행할 수 있습니다.
  ...
  - 요약하면, 최근 10주간의 데이터에 대한 높은 Attention 값은 BDI 예측에 있어 최근 경제 및 금융 상황이 중요하다는 것을 시사하며, 이를 통해 건화물 시장 참가자들은 더 정확한 예측과 전략적 의사결정을 수립할 수 있습니다.
